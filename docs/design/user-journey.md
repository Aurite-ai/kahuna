...
│   │   ├── rules/             ← Behavior rules (use context/, etc.)           │
│   │   └── skills/            ← Sub-agent capabilities                        │
│   ├── context/                                                               │
│   │   ├── README.md          ← Navigation guide                              │
│   │   └── langgraph/         ← Curated patterns (Day 1 value!)               │
│   │       ├── getting-started.md                                             │
│   │       └── patterns.md                                                    │
...
│       └── tools.py                                                           │
│                                                                              │
│   Claude Code reads CLAUDE.md, sees instructions to read context/            │
│   Reads context/README.md, finds curated LangGraph patterns                  │
...
│   4. NOT written to context/ yet (that's prepare_context's job)              │
│                                                                              │
│   Response:                                                                  │
│   ┌─────────────────────────────────────────────────────────────┐            │
│   │ # Context Received                                          │            │
...
│                                                                              │
│   Surfaces to project/context/:                                              │
│   context/                                                                   │
│   ├── README.md               ← Updated navigation                           │
│   ├── langgraph/              ← Already present                              │
│   │   └── patterns.md                                                        │
│   └── task/                   ← New! Task-specific context                   │
│       ├── api-standards.md    ← Relevant policy                              │
│       └── tool-patterns.md    ← LangGraph tool guidance                      │
│                                                                              │
│   Response:                                                                  │
│   ┌─────────────────────────────────────────────────────────────┐            │
│   │ # Context Ready                                             │            │
...
│   │                                                             │            │
│   │ <hints>                                                     │            │
│   │ - Read context/README.md for full navigation                │            │
│   │ - API standards apply to any endpoints you create           │            │
│   │ - Use kahuna_ask if you need clarification mid-task         │            │
│   │ </hints>                                                    │            │
│   └─────────────────────────────────────────────────────────────┘            │
│                                                                              │
│   Claude Code reads context/README.md, sees what's available                 │
│   Reads relevant files based on task needs                                   │
...
- Claude Code reads `context/` like any other files
...
│                                                                              │
│   Kahuna searches:                                                           │
│   1. First: project/context/ (already surfaced)                              │
...
│   │                                                             │            │
│   │ From **API Design Standards** (context/task/api-standards): │            │
│   │                                                             │            │
...
│   │                                                             │            │
│   │ <hints>                                                     │            │
│   │ - Full details in context/task/api-standards.md             │            │
...
- Checks `context/` first (already task-relevant)
